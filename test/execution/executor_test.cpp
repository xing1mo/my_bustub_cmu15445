...
TEST_F(ExecutorTest, MyRawInsertTest) {
  ...
  // Size
  ASSERT_EQ(result_set.size(), 503);

  // First value
  ASSERT_EQ(result_set[500].GetValue(out_schema, out_schema->GetColIdx("colA")).GetAs<int32_t>(), 100);
  ASSERT_EQ(result_set[500].GetValue(out_schema, out_schema->GetColIdx("colB")).GetAs<int32_t>(), 2);

  // Second value
  ASSERT_EQ(result_set[501].GetValue(out_schema, out_schema->GetColIdx("colA")).GetAs<int32_t>(), 101);
  ASSERT_EQ(result_set[501].GetValue(out_schema, out_schema->GetColIdx("colB")).GetAs<int32_t>(), 3);

  // Third value
  ASSERT_EQ(result_set[502].GetValue(out_schema, out_schema->GetColIdx("colA")).GetAs<int32_t>(), 102);
  ASSERT_EQ(result_set[502].GetValue(out_schema, out_schema->GetColIdx("colB")).GetAs<int32_t>(), 4);
